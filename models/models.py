...
from utils.utils import weights_init_normal, xyxy2xywh
# from lib.models.TransFuse import BiFusion_block, Vit_S
...
def load_model(model_path, weights_path=None, args=None):
